...
public class Constants {
	...
	public static final String SHOW_WEEK = "/todolist/week";
	...
	public static final String SQL_SELECT_ALL_TASKS_WEEK = "SELECT * FROM TASK WHERE STATUS = \'P\' AND DUE_DATE BETWEEN ? and ? ORDER BY DUE_DATE ASC";
